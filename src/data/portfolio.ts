      ...
      bilan: [
        {
          ...
          elementaryDetails: [
            {
              name: 'Décomposer une fonctionnalité en étapes de test atomiques',
              context: 'Pour chaque écran de MAESTRO, traduction des fonctionnalités en suites d\'étapes action / résultat attendu vérifiables.',
              learningContext: 'Découvert en stage.',
              difficulty: 'Moyen',
            },
            {
              name: 'Rédiger un cas de test au formalisme importable d\'Azure DevOps',
              context: 'Rédaction sous Excel respectant les colonnes attendues par le module Test Plans, puis import dans Azure DevOps.',
              learningContext: 'Entièrement découvert en stage ; je ne connaissais ni Azure DevOps ni ce formalisme.',
              difficulty: 'Moyen',
            },
            {
              name: 'Organiser les cas de test en suites thématiques',
              context: 'Rangement des cas de test par écran de l\'application dans Azure DevOps.',
              learningContext: 'Découvert en stage.',
              difficulty: 'Faible',
            },
            {
              name: 'Versionner les campagnes de test',
              context: 'Construction de plans de test incrémentaux par version (V1.6, V1.7) pour historiser les campagnes avant déploiement.',
              learningContext: 'Découvert en stage, sur demande du métier.',
              difficulty: 'Faible',
            },
          ],
          context: 'Conception et organisation des cas de test des écrans de MAESTRO chez APRR.',
          learningContext: 'Compétence entièrement construite lors du stage.',
          difficulty: 'Moyen',
          level: 'Bon',
          levelBefore: 'Faible',
          levelAfter: 'Bon',
          levelBeforeText: 'Pendant ma formation en BUT, j\'avais abordé les tests unitaires et l\'usage d\'un outil comme Jenkins pour lancer des builds, mais je ne connaissais les tests de bout en bout que de nom, et je n\'avais jamais pratiqué la rédaction formalisée de cas de test ni utilisé Azure DevOps.',
          levelAfterText: 'Je suis désormais capable de prendre un écran d\'une application, d\'en analyser les fonctionnalités et d\'en déduire un jeu complet de cas de test rédigés au formalisme d\'Azure DevOps, puis de les organiser en campagnes versionnées. La boucle de validation avec le métier — j\'envoyais mes cas de test à mon tuteur, qui pointait les fonctionnalités ou étapes oubliées avant que je ne les injecte et les code — m\'a appris à concevoir des cas de test à la fois exhaustifs et alignés sur le besoin réel.',
        },
        {
