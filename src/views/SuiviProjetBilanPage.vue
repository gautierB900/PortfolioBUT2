...
const data = portfolioData.sections.suiviProjet
</script>
...
<template>
  <div class="page-container">
    ...
    <p class="text-body2 text-grey mb-6">
      Analyse des savoir-faire généraux et de votre progression dans ces domaines.
    </p>
    ...
    <div class="mt-6 d-flex justify-space-between">
      <v-btn color="primary" variant="outlined" @click="router.push('/suivi-projet/description')">
        Voir la Description
      </v-btn>
